...
<CenteredImage
  src="/src/assets/getting-started-configuration-create-bot.png"
...
<CenteredImage
  src="/src/assets/getting-started-configuration-intents.png"
  alt="setting-intents"
  height="390"
  width="717"
/>
...
<CenteredImage
  src="/src/assets/getting-started-configuration-bot-token.png"
  alt="setting-intents"
  height="130"
  width="714"
/>
